...
$config->custom->session['blowfish'] = '{{ random_string.stdout }}';
...
$servers->setValue('server','host','{{ phpldapadmin_ldap_uri }}');
...
$servers->setValue('server','base',array('{{ phpldapadmin_dn }}'));
